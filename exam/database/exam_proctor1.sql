...
CREATE TABLE `examinee_tbl` (
  ...
  FOREIGN KEY(exmne_course) REFERENCES course_tbl(cou_id) ON DELETE CASCADE 
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `exam_tbl` (
  ...
  FOREIGN KEY(cou_id) REFERENCES course_tbl(cou_id) ON DELETE CASCADE 
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `exam_question_tbl` (
  ...
  FOREIGN KEY(exam_id) REFERENCES exam_tbl(ex_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `exam_answers` (
  ...
  FOREIGN KEY(exmne_id) REFERENCES examinee_tbl(exmne_id) ON DELETE CASCADE,
  FOREIGN KEY(exam_id) REFERENCES exam_tbl(ex_id) ON DELETE CASCADE,
  FOREIGN KEY(quest_id) REFERENCES exam_question_tbl(eqt_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
